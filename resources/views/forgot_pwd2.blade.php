...
<div class="container  mt-5">
    ...
    <form action="{{url('forgot_pwd2_function')}}" method="post">
        @csrf
...
">Forgot Password</u></h2></div><br><br>
        <div class="row"style="
    font-size: x-large;
"><div class="col-md-4">E-mail</div><div class="col-md-6">   <input type="text" name="email" class="form-control" required> </div>
</div><br>
   <div class="row"style="
    font-size: x-large;
"><div class="col-md-4">Phone</div><div class="col-md-6">   <input type="text" name="phone" class="form-control" required></div></div>
<br>
   <div class="row">
   <input type="submit" value="Next" class="btn btn-success"style="
    font-size: x-large;
"></div>
</form>
</div>
