...
<div class="container  mt-5">
    ...
    <form action="{{url('forgot_pwd_function')}}" method="post">
        @csrf
        <div class="row text-center"><h1><u style="
    font-size: larger;
">Forgot Password</u></h1></div><br>
       <div class="row"style="
    font-size: x-large;
"><div class="col-md-3"style="
    font-size: x-large;
">Username</div><div class="col-md-8">    <input type="text" name="uname" class="form-control" required>
</div>

</div><br>
<div class="row">    <input type="submit" value="Next" class="btn btn-success"style="
    font-size: x-large;
">
</div>
</form>
