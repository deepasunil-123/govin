...
<body style="background-image:url('images/i8.jpg'); background-size:cover"><div class="navbar navbar-expand-lg navbar-dark bg-success">
        <div class="container">
...
<div class="container  mt-5">
   ...
   <form action="{{url('buyer_insert_form')}}" method="post" enctype="multipart/form-data">
    @csrf
...
<br>
    ...
    font-size: x-large;
">Email</div>
<div class="col">    <input type="mail" name="email" class="form-control"required></div>
...
<div class="col-md-3"style="
    font-size: x-large;
">Place</div><div class="col">    <input type="text" name="place"required class="form-control">
</div>
</div><br>
...
<div class="col-md-3"style="
    font-size: x-large;
">Username</div><div class="col">    <input type="text" name="uname"required class="form-control">
</div>
</div><br>

    <div class="row"><div class="col-md-3"style="
    font-size: x-large;
">Password</div><div class="col">    <input type="password" name="pwd" class="form-control"required><br>
</div><br>
    ...
    <div class="row"><div class="col-md-3"style="
    font-size: x-large;
">Photo</div><div class="col">    <input type="file" name="photo" class="form-control"required><br>
</div><br>
