...
<body style="background-image:url('images/i5.jpg');background-size:cover">
...
<div class="container  mt-5 bg-warning">
    ...
    <thead class="text-danger bg-warning"style="font-size:x-large;">
        ...
        <tbody class="bg-success">
            ...
            <tr style="font-size: x-large;background-color: antiquewhite;"><td>{{$result->f_name}}</td>
            <td>{{$result->email}}</td>
            <td>{{$result->total}}</td>
            <td>{{$result->status}}</td>
            ...
            <td>    <a href="{{url('admin_view_order_details',$result->pid)}}" class="btn btn-success" style="font-size: x-large;">Details</a>
</td>
