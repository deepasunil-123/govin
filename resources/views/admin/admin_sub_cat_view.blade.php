...
">
        <th>Category_Name</th>
        <th>Sub_category_Name</th><th></th><th></th></thead>
        <tbody>
...
"><td>{{$result->cat_name}}</td>
            <td>{{$result->sub_cat_name}}</td>
             <td>    <a href="{{url('admin_edit_sub_cat',$result->id)}}"class="btn btn-success">Edit</a></td>
<td>    <a href="{{url('admin_delete_sub_cat',$result->id)}}"class="btn btn-success">Delete</a></td>
